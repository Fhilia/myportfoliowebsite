    ...
    <section className="py-32 px-6 md:px-20 max-w-7xl mx-auto border-t border-gray-100 bg-white">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
        ...
        >
          ...
          <div className="flex gap-4 pt-4">
            <motion.button 
              ...
              className="group flex items-center gap-3 px-8 py-4 bg-[#47474F] text-white rounded-full font-bold hover:bg-[#333339] transition-all shadow-lg shadow-[#47474F]/10"
            >
        ...
        <motion.div 
          ...
          className="grid grid-cols-1 gap-8 md:pt-20"
        >
          <motion.div variants={itemVariants} className="group space-y-4 p-10 rounded-[48px] border border-gray-100 bg-[#F9F9F9] transition-all duration-500 hover:bg-white hover:shadow-[0_40px_80px_-15px_rgba(0,0,0,0.08)] hover:-translate-y-2">
